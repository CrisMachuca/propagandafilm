...
function setCookie(name, value, days) {
  ...
  // Código para indicar que las cookies han sido gestionadas en la ventana emergente
  localStorage.setItem('cookies_managed', 'true');
  ...
  window.close();
  // Verificar si las cookies han sido gestionadas
  const cookieManaged = localStorage.getItem('cookies_managed');
